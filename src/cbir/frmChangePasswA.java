...
public class frmChangePasswA extends javax.swing.JFrame {
    UserDAO UD = new UserDAO();
Statement st=null;
ResultSet rs=null;
String uname="";

    public frmChangePasswA(String uname) {
        initComponents();
        this.uname=uname;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            rs=st.executeQuery("select * from user_details where userid='"+uname+"' and usertype='a'");
            if(rs.next())
            {
            ...
            st.execute("update user_details set password='"+newp+"' where userid='"+uname+"' and usertype='a'");
